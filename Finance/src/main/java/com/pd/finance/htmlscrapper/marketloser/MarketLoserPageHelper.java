...
public class MarketLoserPageHelper {
    private static final Logger logger = LoggerFactory.getLogger(MarketLoserPageHelper.class);


    public static Node extractMarketLosersTableNode(Document document, String exchange)   {
    ...
    public static List<Node> extractMarketLoserRows(Node histTable) {

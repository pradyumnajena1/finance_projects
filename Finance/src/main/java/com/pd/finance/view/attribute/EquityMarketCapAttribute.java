...
public class EquityMarketCapAttribute extends BaseEquityViewAttribute implements IViewAttribute<Equity> {
    public EquityMarketCapAttribute(IEquityViewAttributeProvider attributeProvider, String name, String displayName) {
